...
import  maseratikpi.maserati.webwechat.wechat.core.common.util.CollectionUtil;
...
import  maseratikpi.maserati.webwechat.wechat.core.service.api.entity.UserInfo;
import  maseratikpi.maserati.webwechat.wechat.core.service.api.enums.ResultType;
import  maseratikpi.maserati.webwechat.wechat.core.service.api.response.*;
...
public class UserAPI extends BaseAPI {
	 ...
	 * @return
	 */
	public GetUserTagListResponse getUserTagList() {
		LOG.debug("取得用户标签列表.....");
		String url = BASE_API_URL + "cgi-bin/tags/get?access_token=#";
		BaseResponse r = executeGet(url);
		System.out.println("=====================");
		System.out.println("json=" + r.toJsonString());
		String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
		GetUserTagListResponse getUserTagListResponse = JSONUtil.toBean(resultJson, GetUserTagListResponse.class);
