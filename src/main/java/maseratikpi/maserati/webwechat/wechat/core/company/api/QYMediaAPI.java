...
import  maseratikpi.maserati.webwechat.wechat.core.common.util.NetWorkCenter;
import  maseratikpi.maserati.webwechat.wechat.core.common.util.StreamUtil;
import  maseratikpi.maserati.webwechat.wechat.core.company.api.config.QYAPIConfig;
import  maseratikpi.maserati.webwechat.wechat.core.company.api.response.DownloadMediaResponse;
import  maseratikpi.maserati.webwechat.wechat.core.company.api.response.UploadMediaResponse;
import  maseratikpi.maserati.webwechat.wechat.core.service.api.enums.MediaType;
